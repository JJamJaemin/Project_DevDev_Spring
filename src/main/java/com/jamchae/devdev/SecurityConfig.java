    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/join", "/loginpage", "/joinpage", "/postpage", "/boards", "/boards/create-post", "/boards/create-post-form", "/mypage", "/api/", "/api/user", "/api/user/update").permitAll()
